...
public class Model {
	...
	public void creaGrafo() {
		...
		List<Fermata> adiacenti= Graphs.successorListOf(grafo,f); //non devo più pensare agli archi ma 
		//solo ai vertici -> METODO MIGLIORE 
		 */
	}
	...
	public List<Fermata> fermateRaggiungibili(Fermata partenza){
		...
		bfv.addTraversalListener(new TraversalListener<Fermata,DefaultEdge>(){
			...
			public void edgeTraversed(EdgeTraversalEvent<DefaultEdge> e) {
				...
				//ho scoperto 'a' arrivando da b (quindi b lo conoscevo gia)
			...
			public void vertexTraversed(VertexTraversalEvent<Fermata> e) {
				...
				//Fermata precedente; 
				//vertice adiacente a nuova che sia già raggiunto  (cioè gia presente nella mappa)
